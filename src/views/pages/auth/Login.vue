                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="login">
                        <div>
                            ...
                            <InputText id="login" type="text" placeholder="Введите логин" class="w-full md:w-[30rem] mb-8" v-model="formState.login" />

                            <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Пароль</label>
                            <Password id="password1" v-model="formState.password" placeholder="Введите пароль" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>

                            <Button label="Войти" class="w-full" type="submit"></Button>
                        </div>
